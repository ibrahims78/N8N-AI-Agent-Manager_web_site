...
import { CatalogAdminPanel } from "@/components/docs/CatalogAdminPanel";
    ...
    <div className="space-y-6 max-w-2xl" dir={isRTL ? "rtl" : "ltr"}>
      {isAdmin && (
        <>
          ...
          {/* n8n Node Catalog — full documentation control panel (relocated from /nodes-catalog). */}
          {isAdmin && <CatalogAdminPanel isRTL={isRTL} defaultOpen />}
