...
> **🔗 Templates & examples:** browse ready-made workflows for pinecone-vector-store at [https://docs.n8n.io/integrations/builtin/cluster-nodes/root-nodes/n8n-nodes-langchain.vectorstorepinecone/](https://docs.n8n.io/integrations/builtin/cluster-nodes/root-nodes/n8n-nodes-langchain.vectorstorepinecone/)
...
![Screenshot of a Pinecone account, with the Pinecone index labelled](/api/catalog/docs/assets/_at_n8n__n8n-nodes-langchain.vectorStorePineconeInsert/pinecone-index-namespace.png)