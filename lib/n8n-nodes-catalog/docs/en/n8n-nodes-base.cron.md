...
1. Select the <span class="n8n-inline-image">![three dots menu](/api/catalog/docs/assets/n8n-nodes-base.cron/three-dots-horizontal.png)</span> **Three dots icon** in the upper-right corner.
1. Select **Settings**.
