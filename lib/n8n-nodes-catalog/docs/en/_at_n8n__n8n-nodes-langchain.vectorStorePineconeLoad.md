...
![Screenshot of a Pinecone account, with the Pinecone index labelled](/api/catalog/docs/assets/_at_n8n__n8n-nodes-langchain.vectorStorePineconeLoad/pinecone-index-namespace.png)