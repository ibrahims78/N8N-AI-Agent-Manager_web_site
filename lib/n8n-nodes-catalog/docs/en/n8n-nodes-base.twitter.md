...
> Learn how to use the X (Formerly Twitter) node in n8n. Follow technical documentation to integrate X (Formerly Twitter) node into your workflows.
...
> **🔗 Templates & examples:** browse ready-made workflows for twitter at [https://docs.n8n.io/integrations/builtin/app-nodes/n8n-nodes-base.twitter/](https://docs.n8n.io/integrations/builtin/app-nodes/n8n-nodes-base.twitter/)