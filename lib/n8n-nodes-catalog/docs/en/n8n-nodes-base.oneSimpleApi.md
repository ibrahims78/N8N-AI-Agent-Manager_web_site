# One Simple API node documentation

> Learn how to use the One Simple API node in n8n. Follow technical documentation to integrate One Simple API node into your workflows.
...
> **🔗 Templates & examples:** browse ready-made workflows for one-simple-api at [https://docs.n8n.io/integrations/builtin/app-nodes/n8n-nodes-base.onesimpleapi/](https://docs.n8n.io/integrations/builtin/app-nodes/n8n-nodes-base.onesimpleapi/)
