...
??? Details "View screenshot"
	![Customizable text elements](/api/catalog/docs/assets/_at_n8n__n8n-nodes-langchain.chatTrigger/hosted-text-elements.png)
...
??? Details "View screenshot"
	![Connect nodes to memory](/api/catalog/docs/assets/_at_n8n__n8n-nodes-langchain.chatTrigger/connect-memory.png)
...
??? Details "View screenshot"
	![New Conversation button](/api/catalog/docs/assets/_at_n8n__n8n-nodes-langchain.chatTrigger/new-conversation-button.png)
