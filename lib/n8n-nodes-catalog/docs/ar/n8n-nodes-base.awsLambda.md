...
استخدم عقدة AWS Lambda لأتمتة سير العمل في AWS Lambda، ودمج AWS Lambda مع التطبيقات الأخرى. تدعم n8n مجموعة واسعة من ميزات AWS Lambda بشكل مدمج، بما في ذلك استدعاء الدوال.

ستجد في هذه الصفحة قائمة بالعمليات التي تدعمها عقدة AWS Lambda وروابط لموارد إضافية.

> **بيانات الاعتماد**
>
> ارجع إلى [بيانات اعتماد AWS Lambda](/integrations/builtin/credentials/aws.md) للحصول على إرشادات حول إعداد المصادقة.
