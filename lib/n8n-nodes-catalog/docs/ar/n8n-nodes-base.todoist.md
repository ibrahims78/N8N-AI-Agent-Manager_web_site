...
استخدم عقدة Todoist لأتمتة سير العمل في Todoist، ودمج Todoist مع تطبيقات أخرى. تدعم n8n مجموعة واسعة من ميزات Todoist بشكل مدمج، بما في ذلك إنشاء المهام وتحديثها وحذفها واستردادها.

في هذه الصفحة، ستجد قائمة بالعمليات التي تدعمها عقدة Todoist وروابط لموارد إضافية.

> **بيانات الاعتماد**
>
> ارجع إلى [بيانات اعتماد Todoist](/integrations/builtin/credentials/todoist.md) للحصول على إرشادات حول إعداد المصادقة.
