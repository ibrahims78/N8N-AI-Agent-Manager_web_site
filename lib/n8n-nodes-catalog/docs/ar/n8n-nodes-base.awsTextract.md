...
استخدم عقدة AWS Textract لأتمتة سير العمل في AWS Textract، ودمج AWS Textract مع تطبيقات أخرى. تدعم n8n بشكل مدمج مجموعة واسعة من ميزات AWS Textract، بما في ذلك تحليل الفواتير.

في هذه الصفحة، ستجد قائمة بالعمليات التي تدعمها عقدة AWS Textract وروابط لموارد إضافية.

> **بيانات الاعتماد**
>
> ارجع إلى [بيانات اعتماد AWS Textract](/integrations/builtin/credentials/aws.md) للحصول على إرشادات حول إعداد المصادقة.
