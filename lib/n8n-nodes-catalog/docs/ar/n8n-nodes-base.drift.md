...
استخدم عقدة Drift (درِفت) لأتمتة سير العمل في Drift، ودمج Drift مع تطبيقات أخرى. تدعم n8n بشكل مدمج مجموعة واسعة من ميزات Drift، بما في ذلك إنشاء جهات الاتصال وتحديثها وحذفها والحصول عليها.

ستجد في هذه الصفحة قائمة بالعمليات التي تدعمها عقدة Drift وروابط لموارد إضافية.

> **بيانات الاعتماد**
>
> ارجع إلى [بيانات اعتماد Drift](/integrations/builtin/credentials/drift.md) للحصول على إرشادات حول إعداد المصادقة.

## العمليات

*   جهة الاتصال
    *   إنشاء جهة اتصال
    *   الحصول على السمات المخصصة
    *   حذف جهة اتصال
