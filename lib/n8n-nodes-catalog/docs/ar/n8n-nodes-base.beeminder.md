...
استخدم عقدة Beeminder لأتمتة سير العمل في Beeminder، ودمج Beeminder مع تطبيقات أخرى. تدعم n8n مجموعة واسعة من ميزات Beeminder بشكل مدمج، بما في ذلك إنشاء نقاط البيانات وحذفها وتحديثها.
