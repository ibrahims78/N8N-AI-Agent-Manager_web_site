...
استخدم عقدة Pushover لأتمتة سير العمل في Pushover، ودمج Pushover مع تطبيقات أخرى. تدعم n8n إرسال إشعارات الدفع (push notifications) باستخدام Pushover.

في هذه الصفحة، ستجد قائمة بالعمليات التي تدعمها عقدة Pushover وروابط لموارد إضافية.

> **بيانات الاعتماد**
>
> ارجع إلى [بيانات اعتماد Pushover](/integrations/builtin/credentials/pushover.md) للحصول على إرشادات حول إعداد المصادقة.
