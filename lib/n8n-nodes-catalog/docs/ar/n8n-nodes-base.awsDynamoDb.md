...
استخدم عقدة AWS DynamoDB لأتمتة سير العمل في AWS DynamoDB، ودمج AWS DynamoDB مع تطبيقات أخرى. تدعم n8n بشكل مدمج مجموعة واسعة من ميزات AWS DynamoDB، بما في ذلك إنشاء العناصر وقراءتها وتحديثها وحذفها، والسجلات في قاعدة البيانات.
