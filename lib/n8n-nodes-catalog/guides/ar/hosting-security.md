...
*   [تنقيح بيانات التنفيذ](/workflows/executions/execution-data-redaction.md) لإخفاء بيانات المدخلات والمخرجات من عمليات تنفيذ سير العمل.

بشكل أكثر تفصيلاً، فكر في حظر أو إلغاء الاشتراك في الميزات أو جمع البيانات التي لا ترغب فيها:

*   [تعطيل واجهة برمجة التطبيقات العامة (API)](/hosting/securing/disable-public-api.md) إذا كنت لا تستخدمها.
...
*   [تقييد تسجيل الحسابات](/hosting/securing/restrict-by-email-verification.md) على المستخدمين الذين تم التحقق من بريدهم الإلكتروني.